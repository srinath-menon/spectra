    ...
    def generate_gallery_html(self):
        ...
        <head>
            ...
            <style>
                ...
                #current-folder-label {{ font-size: 0.9rem; color: #888; font-weight: bold; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; padding: 0 10px; }}
        ...
        <body>
            ...
            <script>
                ...
                function filterByFolder(folderPath) {{
                    ...
                    folderLabel.innerText = folderPath;
                    applyFilterUpdate();
                    toggleFolders();
                }}
                function resetFilter() {{
                    filteredImages = [...allImages];
                    folderLabel.innerText = "[All Photos]";
                    applyFilterUpdate();
